    ...
    <div class="flex items-center w-11/12">
      <div class="w-1/3">
        <div class="flex items-center">
          <router-link to="/" class="font-bold mr-4">
            Laravue Questions
          </router-link>
          <a>
            About
      ...
      <div class="w-1/3">
        <div class="ml-2 relative">
          ...
          <input type="text" name="search" class="w-full pl-8 bg-gray-200 border-gray-300 focus:border-gray-400 focus:shadow-outline focus:ring-1 ring-gray-500 focus:ring-gray-500 focus:ring-opacity-50 cursor-text h-8 rounded-full focus:outline-none focus:shadow-outline text-sm" placeholder="Search...">
        </div>
      </div>
